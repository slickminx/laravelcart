    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview {{request()->is('addcategory') || request()->is('categories') ? 'menu-open' : ''}}">
            <a href="#" class="nav-link">
          ...
          <li class="nav-item has-treeview {{request()->is('addslider') || request()->is('sliders') ? 'menu-open' : ''}}">
            <a href="#" class="nav-link">
              <i class="nav-icon fas fa-folder"></i>
              <p>
                Sliders
          ...
          <li class="nav-item has-treeview {{request()->is('addproduct') || request()->is('products') ? 'menu-open' : ''}}">
            <a href="#" class="nav-link {{request()->is('addproduct') || request()->is('products') ? 'active' : ''}}">
              <i class="nav-icon fas fa-folder"></i>
              <p>
                Products
                <i class="fas fa-angle-left right"></i>
