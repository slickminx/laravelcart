              ...
              {{ csrf_field() }}
                <div class="card-body">
                  <div class="form-group">
                    ...
                    {{Form::text('description1', $slider->description1, ['class' => 'form-control', 'id' => 'exampleInputEmail1', 'placeholder' =>
                    'Enter Description 1'])}}
                  </div>
                  <div class="form-group">
                    {{Form::label('', 'Description 2', ['for' => 'exampleInputEmail1'])}}
                    {{Form::text('description2', $slider->description2 , ['class' => 'form-control', 'id' => 'exampleInputEmail1', 'placeholder' =>
                    'Enter Description 2'])}}
                  </div>
                  <label for="exampleInputFile">Slider image</label>
                  <div class="input-group">
                    <div class="custom-file">
                      {{Form::file('slider_image', ['class' => 'custom-file-input', 'id' => 'exampleInputEmail1'])}}
