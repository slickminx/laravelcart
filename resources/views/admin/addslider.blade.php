              ...
              {{ csrf_field() }}
                <div class="card-body">
                  <div class="form-group">
                    ...
                    {{Form::text('description1', '', ['class' => 'form-control', 'id' => 'exampleInputEmail1', 'placeholder' =>
                    'Enter Description 1'])}}
                  </div>
                  <div class="form-group">
                    {{Form::label('', 'Description 2', ['for' => 'exampleInputEmail1'])}}
                    {{Form::text('description2', '', ['class' => 'form-control', 'id' => 'exampleInputEmail1', 'placeholder' =>
                    'Enter Description 2'])}}
                  </div>
