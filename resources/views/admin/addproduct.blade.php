              ...
              {{ csrf_field() }}
                <div class="card-body">
                  <div class="form-group">
                    ...
                    {{Form::text('product_name', '', ['class' => 'form-control', 'id' => 'exampleInputEmail1', 'placeholder' =>
                    'Enter Product'])}}
                  ...
                  <div class="form-group">
                    ...
                    {{Form::text('product_price', '', ['class' => 'form-control', 'id' => 'exampleInputEmail1', 'placeholder' =>
                    'Enter Product Price'])}}
