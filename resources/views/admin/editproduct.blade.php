              ...
              {{ csrf_field() }}
                <div class="card-body">
                  <div class="form-group">
                    ...
                    {{Form::text('product_name', $product->product_name, ['class' => 'form-control', 'id' => 'exampleInputEmail1', 'placeholder' =>
                    'Enter Product'])}}
                  ...
                  <div class="form-group">
                    ...
                    {{Form::text('product_price', $product->product_price, ['class' => 'form-control', 'id' => 'exampleInputEmail1', 'placeholder' =>
                    'Enter Product Price'])}}
                  ...
                  <div class="form-group">
                    {{-- {{Form::select('product_category', $categories, null, ['placeholder' => 'Select cateogries', 'class' => 'form-control select2' ])}} --}}
                  ...
                  <div class="input-group">
                    <div class="custom-file">
                      {{Form::file('product_image', ['class' => 'custom-file-input', 'id' => 'exampleInputEmail1'])}}
